...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('employees')->group(function () {
        ...
        Route::get('/reg/employee', [EmployeeRegController::class, 'EmployeeRegViewAdd'])->name('employee.add');
        Route::post('/reg/employee/store', [EmployeeRegController::class, 'EmployeeRegViewStore'])->name('store.employee.register');
        Route::get('/employee/edit/{employee_id}', [EmployeeRegController::class, 'EmployeeRegViewEdit'])->name('employee.edit');
        Route::post('/employee/edit/{id}', [EmployeeRegController::class, 'EmployeeRegViewUpdate'])->name('update.employee.register');
        Route::get('/employee/details/{id}', [EmployeeRegController::class, 'EmployeeRegViewDetails'])->name('employee.details');
    });
});
