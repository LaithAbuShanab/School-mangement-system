...
<head>
    ...
    <title>Easy Learning - Log in </title>
                    ...
                    <div class="col-lg-4 col-md-5 col-12">
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class=" form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('register') }}" class="text-info ml-5 text-success">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
