                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$student->name}}</td>
                                            <td width="25%">
                                                <a href="{{route('fee.category.edit',$student->id)}}" class="btn btn-info">Edit</a>
                                                <a href="{{route('fee.category.delete',$student->id)}}" class="btn btn-danger" id="delete">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
