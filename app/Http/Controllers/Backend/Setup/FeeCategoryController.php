...
class FeeCategoryController extends Controller
{
    ...
    public function viewFeeCategoryAdd()
    {
        return view('backend.setup.fee_category.add_fee_category');
    }

    public function viewFeeCategoryStore(Request $request)
    {
        $request->validate([
    ...
    public function viewFeeCategoryEdit($id)
    {
        $editData = FeeCategory::find($id);
        return view('backend.setup.fee_category.edit_fee_category', compact('editData'));
    }

    public function viewFeeCategoryUpdate(Request $request, $id)
    {
    ...
    public function viewFeeCategoryDelete($id)
    {
